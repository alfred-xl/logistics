...
include './Email/PHPMailer/email.php';
            ...
            <div class="page-content">
               ...
               <!-- start page title -->
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Email Creator</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Menu</a></li>
                                        <li class="breadcrumb-item active">Email Creator </li>
                                    </ol>
                                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                           <div class="card-body">
                               <h4 class="card-title">Email Creator</h4>
 <?php
// session_start();
...
?>
                               ...
                               <form method="post">
                                ...
                                <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" placeholder="email subject" name="email_subject"  autocomplete="off" autocomplete="no-email"required>
                                   </div>
                                
                                   <div class="form-group">
                                       <label for="exampleFormControlTextarea1">Email Body</label>
                                       <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"n name="email_body" required></textarea>
                                        <script>
                        CKEDITOR.replace( 'email_body' );
                                   ...
                                   <button type="submit" name="submit" class="btn btn-primary waves-effect waves-light">Send</button>
                               </form>
                           </div>
                           <!-- end card-body-->
