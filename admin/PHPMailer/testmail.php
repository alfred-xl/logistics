...
$mail->Host = 'mail.southcelly.com';                       // Specify main and backup SMTP servers
$mail->SMTPAuth = true;                               // Enable SMTP authentication
$mail->Username = 'email@southcelly.com';              // SMTP username
$mail->Password = 'Boateng2019#';               // SMTP password
$mail->SMTPSecure = 'TLS';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to

$mail->setFrom('noreply@southcelly.com', 'Elite Admin');
...
$mail->clearAddresses();
$mail->addAddress('email@southcelly.com');
$mail->Body = $template;
$mail->send();
