...
<title>Elite International Freight & Cargo Limited | Request for Collection</title>
          ...
          <div class="collapse navbar-collapse" id="mainNavigation">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav__item">
                ...
                <li class="nav__item">
                  <a href="request-collection" class="nav__item-link active">Request Collection</a>
                  </li>
                  <li class="nav__item">
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12">
            <h1 class="pagetitle__heading">Request Collection</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <form class="request-quote-form" method="post">
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                 <div>
<?php
...
if (isset($_GET['alert'])) {
    $alertMessage = isset($alertMessage) ? $alertMessage : 'Your form has been successfully submitted.';
...
?>
                  ...
                  <p class="fz-16 mb-45">Request a hassle-free pickup for your shipment with our easy-to-use online form. Elite makes shipping easy!</p>
                </div><!-- /.col-lg-12 -->
              </div><!-- /.row -->
              <div class="row mb-30">
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <h5 class="form__title">Sender's Information</h5>
                  <hr class="mt-0 mb-30">
                </div><!-- /.col-lg-12 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Name"  name="sendername" required>
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                ...
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    <input type="tel" class="form-control" placeholder="Phone" name="senderphone" required>
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Street" name="senderaddress" required>
                  </div>
                </div><!-- /.col-lg-12 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Country" name="sendercountry" required>
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="City" name="sendercity" required>
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Postal Code"name="senderzip" required>
                  </div>
                </div><!-- /.col-lg-4 -->
              </div><!-- /.row -->
              <div class="row mb-30">
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <h5 class="form__title">Receiver's Information</h5>
                  <hr class="mt-0 mb-30">
                </div><!-- /.col-lg-12 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Name"  name="recievername" required>
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    <input type="email" class="form-control" placeholder="Email"  name="recieveremail" required>
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    <input type="tel" class="form-control" placeholder="Phone"  name="recieverphone" required>
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Street" name="recieveraddress" required>
                  </div>
                </div><!-- /.col-lg-12 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Country" name="recievercountry" required>
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="City" name="recievercity" required>
                  </div>
                </div><!-- /.col-lg-4 -->
                <div class="col-sm-12 col-md-4 col-lg-4">
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="Postal Code" name="recieverzip" required>
                  </div>
                </div><!-- /.col-lg-4 -->
              </div><!-- /.row -->
               <input type="hidden" class="form-control"  name="packagestatus" value="processing">
              <div class="row mb-10">
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <h5 class="form__title">Package Information</h5>
                  <hr class="mt-0 mb-30">
                </div><!-- /.col-lg-12 -->
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                      <textarea class="form-control"
                        placeholder="Package Description" name="packagedescription" required></textarea>
                    </div>
                </div><!-- /.col-lg-12 -->
              </div><!-- /.row -->
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                  <button type="submit" name="submit" class="btn btn__secondary btn__block">Request A Quote</button>
                </div><!-- /.col-lg-12 -->
              </div><!-- /.row -->
            </form>
          </div><!-- /.col-lg-8 -->
